...
namespace Biblioteca_V1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Título: " + MinhaBiblioteca.Titulo);
            Console.WriteLine("Páginas: " + MinhaBiblioteca.Paginas);
